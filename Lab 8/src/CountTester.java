...
public class CountTester {
	...
	public static void main(String[] args) {
		...
		System.out.println("Count of nodes = " + tree1.count() + "\n");
		...
		System.out.println("Count of nodes = " + tree2.count() + "\n");
		...
		System.out.println("Count of nodes = " + tree3.count() + "\n");
		...
		System.out.println("Count of nodes = " + tree4.count() + "\n");
		...
		System.out.println("Count of nodes = " + tree5.count() + "\n");
		...
		System.out.println("Count of nodes = " + tree6.count() + "\n");
		...
		System.out.println("Count of nodes = " + tree7.count() + "\n");
