...
public class HeightTester {
	...
	public static void main(String[] args) {
		...
		System.out.println("Tree height = " + tree3.height() + "\n");
		...
		System.out.println("Tree height = " + tree4.height() + "\n");
		...
		System.out.println("Tree height = " + tree5.height() + "\n");
		...
		System.out.println("Tree height = " + tree6.height() + "\n");
		...
		System.out.println("Tree height = " + tree7.height() + "\n");
